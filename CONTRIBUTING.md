Contributing to STUDIIS
===============================

There are many ways to contribute to STUDIIS.

  * Submit a feature request or bug, or add to the discussion on the [STUDIIS issue tracker][is]
  * Submit a [Pull Request][pr] to improve STUDIIS.
...
If you are new to STUDIIS development and you don't have push access to the STUDIIS
...
When submitting a PR, make sure to add a `Cc: @STUDIIS/developers` comment to
notify STUDIIS developers of your awesome contributions. Based on the
...
* You do NOT have push access: A STUDIIS core developer will integrate your PR.
...
[pr]: https://github.com/Kitware/STUDIIS/merge_requests
[is]: https://github.com/Kitware/STUDIIS/issues
